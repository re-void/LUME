...
import { saveIdentityKeys, loadSettings, saveSettings, savePreKeyMaterial } from '@/crypto/storage';
...
export default function RecoverPage() {
  ...
  const handleRecover = async () => {
    ...
    try {
      ...
      const { data, error: getUserError } = await authApi.getUser(username);
      ...
      setAuth(data.id, data.username, identity, pin);
      router.push('/chats');
    } catch (recoverError) {
