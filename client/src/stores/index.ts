...
interface AuthState {
    ...
    // Actions
    setAuth: (userId: string, username: string, keys: IdentityKeys, pin: string) => void;
    clearAuth: () => void;
    setPin: (pin: string) => void;
}

// SECURITY: Never persist secret keys or PIN in web storage. Keep them in-memory only.
